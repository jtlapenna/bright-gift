...
- **Tracking:** Always use `bright-gift-20` for Amazon, `brightgift` for Bookshop.org
- **Anchor Text:** "View on Amazon" or "View on Bookshop.org" for consistency
...
5. **Style-based:** "handmade gifts for teachers", "eco-friendly gifts"
