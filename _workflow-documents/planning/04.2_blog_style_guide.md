...
### 📈 Data-Driven SEO Optimization (2025 Update)
- Review Google Search Console (GSC) monthly for queries with impressions but low clicks or low average position.
- Update meta titles and descriptions to improve click-through rate (CTR) for posts with impressions but no clicks.
- Expand or refresh content for queries that are getting impressions but rank low (position >20).
- Add internal links to boost visibility of high-potential posts.
- Use GSC data to guide new content topics and update underperforming posts.

### 📝 Content Performance Review (add to checklist)
- [ ] Review GSC data monthly for impressions/clicks
- [ ] Update meta titles/descriptions for CTR
- [ ] Refresh or expand posts with impressions but low ranking
- [ ] Add internal links to high-potential posts
