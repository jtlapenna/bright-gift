...
- [ ] **Affiliate disclosure:** Handled by template automatically
...
- [ ] Affiliate disclosure is handled by template (no need to check)
...
- Affiliate disclosure handled by template
