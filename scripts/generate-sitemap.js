...
const staticPages = [
  ...
  { url: '/last-minute-gifts-for-mom/', priority: '0.8', changefreq: 'weekly' },
  { url: '/last-minute-gifts-for-dad/', priority: '0.8', changefreq: 'weekly' },
  { url: '/last-minute-gifts-for-coworkers/', priority: '0.8', changefreq: 'weekly' },
  { url: '/last-minute-gifts-for-teens/', priority: '0.8', changefreq: 'weekly' },
  ...
  { url: '/white-elephant-gifts-under-25/', priority: '0.8', changefreq: 'weekly' },
  { url: '/stocking-stuffers-under-25/', priority: '0.8', changefreq: 'weekly' },
  { url: '/teacher-christmas-gifts/', priority: '0.8', changefreq: 'weekly' },
  { url: '/office-holiday-gifts/', priority: '0.8', changefreq: 'weekly' },
  { url: '/holiday-hostess-gifts/', priority: '0.8', changefreq: 'weekly' },
  { url: '/neighbor-christmas-gifts/', priority: '0.8', changefreq: 'weekly' },
